    ...
    public class ServiceDescriptorFactory
    {
        public List<ServiceDescriptor> CreateServiceDescriptors(string filePath)
        {
            ...
            foreach (var component in components)
            {
                ...
                {
                    var interfaceType = EnsureComponentService(component.Service);
        ...
        private string MyFunction(Type type)
        {
            var constructor = type.GetConstructors(BindingFlags.CreateInstance);
